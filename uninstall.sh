...
echo "  • Claude-Code skill: $CLAUDE_SKILL_DIR"
echo "  • Claude link:       $CLAUDE_SKILL_CLAUDE_LINK (symlink)"
...
[[ -L "$CLAUDE_SKILL_CLAUDE_LINK" ]] && rm -f "$CLAUDE_SKILL_CLAUDE_LINK" && echo "✓ Removed $CLAUDE_SKILL_CLAUDE_LINK"
