...
2. Choose a path under [Plans and billing](https://cursor.com/help/grok-bot/plans.md): Ultra or SuperGrok Heavy.
...
| ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Computer reset or update is stuck              | Update the desktop app, fully quit and reopen Grok Bot, then reopen the agent's computer and give it time to finish.                                                                                    | See [Recover Grok Bot computer data](https://cursor.com/help/grok-bot/computer-recovery.md). Use **Reset** only as a last resort, since anything not yet synced will not come back.  |
| A routine isn't running                        | Confirm the routine is enabled and its schedule is correct.                                                                                                                                             | If it's enabled but hasn't run for 24+ hours with no error shown, [report a bug](https://cursor.com/help/troubleshooting/reporting-bugs.md) with the agent name and routine details. |
| An error or crash during a run                 | Note the exact error text and the request ID for the run, then try the task again.                                                                                                                      | If the same prompt fails on a fresh run, [report a bug](https://cursor.com/help/troubleshooting/reporting-bugs.md) and include the error text and request ID.                        |
...
- [Recover Grok Bot computer data](https://cursor.com/help/grok-bot/computer-recovery.md)
