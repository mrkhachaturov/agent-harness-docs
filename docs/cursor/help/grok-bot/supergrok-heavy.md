...
Linking is a **usage grant**, not a Cursor plan. It grants Grok Bot usage on the linked Cursor account while your SuperGrok subscription stays active.
...
No. Your existing Cursor plan stays in place. Linking SuperGrok doesn't cancel a Pro, Pro+, Ultra, or Teams subscription, and it doesn't replace them with another Cursor plan. If you had no Cursor plan before linking, you still don't, and Grok Bot usage comes from the SuperGrok grant alone.
...
No. A SuperGrok link is permanent once created. You can't unlink a Grok account from a Cursor account, and you can't move a link to a different Cursor account.

Sign in with the correct Cursor account before you select **Link Grok Account**. If a link ended up on the wrong Cursor account, [contact support](https://cursor.com/help/grok-bot/get-help.md).
...
The **Link Grok Account** option appears on the **Get Started** paywall screen before you sign in. Once you're past the paywall and inside the main app, Settings does not show a Grok or xAI account link option.
...
If you still don't see **Link Grok Account**, confirm you're not already signed in through another path.
