...
Apple handles in-app subscriptions. Cancel or change the plan in **Apple ID → Subscriptions**. For Apple billing questions, use Apple's subscription support. Cursor can't cancel an Apple in-app plan for you.
