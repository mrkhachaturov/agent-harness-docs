...
No. [Cursor Start](https://cursor.com/help/account-and-billing/cursor-start.md) is only available in India. You'll need to verify an Indian phone number when you subscribe. If you access Cursor from outside India or use a VPN, your requests may be blocked.
